...
(defproject xyz.zcaudate/foundation-fx "4.0.10"
  ...
  [[org.clojure/clojure "1.11.1"]
   ...
   [xyz.zcaudate/js.lib.d3           "4.0.10"]
   [xyz.zcaudate/js.react            "4.0.10"]
   [xyz.zcaudate/lib.docker          "4.0.10"]
   [xyz.zcaudate/net.http            "4.0.10"]
   [xyz.zcaudate/rt.graal            "4.0.10"]
   [xyz.zcaudate/std.image           "4.0.10"]
   [xyz.zcaudate/std.log             "4.0.10"]
   [xyz.zcaudate/std.lang            "4.0.10"]
   [xyz.zcaudate/std.make            "4.0.10"]
